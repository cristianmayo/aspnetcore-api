...
namespace AspNetCore.API.Web
{
    ...
    public partial interface IClient
    {
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<WeatherForecast>> WeatherForecast_GetAsync();
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Get all weather forecast</summary>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<WeatherForecast>> WeatherForecast_GetAsync(System.Threading.CancellationToken cancellationToken);
